...
accelerate launch  --config_file /107556523204/haoqin/code/default2_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_LLM_Seg3D.py \
    --version v0 \
    ...
    --bf16 True \
    --output_dir /107556523204/output/LLM_Seg3D/LaMed-Lora-Llama-8B-step3-ep3 \
    --num_train_epochs 3 \
