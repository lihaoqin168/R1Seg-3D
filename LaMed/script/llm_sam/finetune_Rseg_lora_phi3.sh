...
accelerate launch  --config_file /107556523204/haoqin/code/default3_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_LLM_Seg3D.py \
    --version v0 \
    --model_name_or_path /107556523204/pretrain/Phi-3-mini-4k-instruct \
    --pretrain_mllm /107556523204/output/LLM_Seg3D/LaMed-Lora-Phi3-4B-step3-ep3/model_with_lora.bin \
    --model_type phi3 \
    --lora_enable True \
    ...
    --bf16 True \
    --output_dir /107556523204/output/LLM_Seg3D/LaMed-finetune-rseg-Lora-Phi3-4B-step4-ep3 \
    --num_train_epochs 3 \
