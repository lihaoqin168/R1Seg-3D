...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/M3D-main/eval_Lamed_RSeg.py \
    --model_name_or_path /107556523204/pretrain/M3D-LaMed-Phi-3-4B \
    --num_clicks 2 \
    --model_type M3D \
    --version v0 \
    --test_mode True \
    ...
    --description True \
    --dataset_code $num \
    --output_dir /107556523204/haoqin/code/M3D-ViT-RSeg/eval_M3D_32output2/ \
