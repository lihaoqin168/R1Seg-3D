...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/M3D-ViT-RSeg/eval_Lamed_RSeg.py \
    --model_name_or_path /107556523204/output/M3D-ViT-RSeg/LaMed/output_model/LaMed-llavaMed-7B_2nkSegcnt \
    --num_clicks 2 \
    ...
    --description True \
    --dataset_code $num \
    --output_dir /107556523204/haoqin/code/M3D-ViT-RSeg/eval_llava15_32output2/ \
