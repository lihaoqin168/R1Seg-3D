...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/R1Seg-3D/eval_R1Seg3D.py \
    --model_name_or_path /107556523204/output/R1Seg-3D/output_model/LaMed-Lora-Phi3-4B-step3/ \
    --num_clicks 2 \
    --model_type phi3 \
    --version v0 \
    --test_mode True \
    ...
    --description True \
    --dataset_code $num \
    --output_dir /107556523204/haoqin/eval_RSeg3D/eval_RSeg3D_Phi3_step3/ \
