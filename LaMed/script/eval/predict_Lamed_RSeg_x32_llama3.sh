...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/M3D-ViT-RSeg/eval_R1Seg3D.py \
    --model_name_or_path /107556523204/output/M3D-ViT-RSeg/LaMed/output_model/LaMed-llama3-8B-step4_2nkSegcnt \
    --num_clicks 2 \
    --model_type llama3 \
    --version v0 \
    --test_mode True \
    ...
    --description True \
    --dataset_code $num \
    --output_dir /107556523204/haoqin/code/M3D-ViT-RSeg/eval_llama3_32output2/ \
