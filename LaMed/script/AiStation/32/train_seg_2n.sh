...
accelerate launch --config_file /107556523204/haoqin/code/default4_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_R1Seg3DSAM.py \
    ...
    --gather_loss True \
    --bf16 True \
    --output_dir /107556523204/output/R1Seg-3D/R1Seg-3DSAM-32step1 \
