...
accelerate launch  --config_file /107556523204/haoqin/code/default4_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_R1Seg3D.py \
    ...
    --pretrain_mllm /107556523204/output/R1Seg-3D/LaMed-Lora-Phi3-4B-32step3/model_with_lora.bin \
    --model_type phi3 \
    --lora_enable True \
    ...
    --bf16 True \
    --output_dir /107556523204/output/R1Seg-3D/LaMed-finetune-rseg-Lora-Phi3-4B-32step4 \
    --num_train_epochs 6 \
