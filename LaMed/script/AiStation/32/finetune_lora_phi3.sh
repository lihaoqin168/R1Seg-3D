...
accelerate launch  --config_file /107556523204/haoqin/code/default2_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_R1Seg3D.py \
    --version v0 \
    --num_clicks 2 \
    --model_name_or_path /107556523204/pretrain/Phi-3-mini-4k-instruct \
    --pretrain_mm_mlp_adapter /107556523204/output/R1Seg-3D/LaMed-mmproj-Phi3-4B-32step2/mm_projector.bin \
    --model_type phi3 \
    --lora_enable True \
    --seg_enable True \
    --tune_mm_mlp_adapter false \
    --pretrain_vision_model /107556523204/output/R1Seg-3D/R1Seg-3DSAM-32step1/r1seg_3dsam.bin \
    --bf16 True \
    --output_dir /107556523204/output/R1Seg-3D/LaMed-Lora-Phi3-4B-32step3 \
    --num_train_epochs 6 \
