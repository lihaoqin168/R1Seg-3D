...
accelerate launch  --config_file /107556523204/haoqin/code/default6_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_R1Seg3D.py \
    --version v0 \
    --model_name_or_path /107556523204/pretrain/llava-med-v1.5-mistral-7b \
    --pretrain_mllm /107556523204/output/R1Seg-3D/LaMed-Lora-llavaMed-7B-step3/model_with_lora.bin \
    --model_type llavaMed1.5 \
    --lora_enable True \
    ...
    --bf16 True \
    --output_dir /107556523204/output/R1Seg-3D/LaMed-finetune-rseg-Lora-llava-med-7B-step4 \
    --num_train_epochs 5 \
