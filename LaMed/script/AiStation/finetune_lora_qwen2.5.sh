...
accelerate launch  --config_file /107556523204/haoqin/code/default6_config.yaml /107556523204/haoqin/code/R1Seg-3D/train_RSeg.py \
    ...
    --pretrain_mllm /107556523204/output/R1Seg-3D/LaMed/output/LaMed-qwen-7B-mmproj-X256-step3/checkpoint-20064/pytorch_model.bin \
    --model_type Qwen2.5 \
    --lora_enable True \
    --seg_enable True \
    ...
    --bf16 True \
    --output_dir /107556523204/output/R1Seg-3D/LaMed/output/LaMed-Phi3-4B-finetune-X256-step4 \
    --num_train_epochs 3 \
