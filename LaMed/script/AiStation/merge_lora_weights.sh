...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/R1Seg-3D/merge_lora_weights_and_save_hf_model.py \
    ...
    --model_with_lora /107556523204/output/LLM_Seg3D/LaMed-Lora-Phi3-4B-step3-ep3/model_with_lora.bin \
    --output_dir /107556523204/output/LLM_Seg3D/output_model/LaMed-Lora-Phi3-4B-step3-ep3/
