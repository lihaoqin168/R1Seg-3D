...
CUDA_VISIBLE_DEVICES=0 python /107556523204/haoqin/code/R1Seg-3D/infer_R1Seg3D.py \
    --model_name_or_path /107556523204/output/M3D-ViT-RSeg/LaMed/output_model/LaMed-llama3-8B-finetune-X256-step4_2nk_ep10 \
    --num_clicks 2 \
    --model_type llama3 \
    --version v0 \
    --bf16 True \
    --description True \
    --output_dir /107556523204/haoqin/infer_llama3_R1Seg3D/ \
