...
def sliding_window_inference(
    ...
    **kwargs: Any,
    ...
    for slice_g in range(0, total_slices, sw_batch_size):
        ...
        generate_out = predictor.generate(images=window_data, *args, **kwargs) # batched patch segmentation
        seg_prob = generate_out.get("logits")
        output_generation.append(generate_out.get("output_ids"))
    ...
    return output_generation, output_image[final_slicing]
