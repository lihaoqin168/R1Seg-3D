...
from LaMed.src.model.language_model.qwen2 import Qwen2_5Config

class LamedQwen2Config(Qwen2_5Config):
    model_type = "lamed_Qwen2"

class LamedQwen2Model(LamedMetaModel, Qwen2Model):
    config_class = LamedQwen2Config
    def __init__(self, config: LamedQwen2Config):
        super(LamedQwen2Model, self).__init__(config)

class LamedQwenForCausalLM(LamedMetaForCausalLM, Qwen2ForCausalLM):
    config_class = LamedQwen2Config

    def __init__(self, config):
        super(LamedQwenForCausalLM, self).__init__(config)
...
AutoModelForCausalLM.register(LamedQwen2Config, LamedQwenForCausalLM)