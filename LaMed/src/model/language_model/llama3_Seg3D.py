...
from ..llm_sam_arch import LamedMetaModel, LamedMetaForCausalLM

class LamedLlamaConfig(LlamaConfig):
    model_type = "llama_seg3d"

class Llama3_Seg3DModel(LamedMetaModel, LlamaModel):
    config_class = LamedLlamaConfig
    def __init__(self, config: LlamaConfig):
        super(Llama3_Seg3DModel, self).__init__(config)


class Llama3_Seg3DForCausalLM(LamedMetaForCausalLM, LlamaForCausalLM):
    config_class = LamedLlamaConfig

    def __init__(self, config):
        super(Llama3_Seg3DForCausalLM, self).__init__(config)
        self.model = Llama3_Seg3DModel(config)
...
AutoConfig.register("llama_seg3d", LlamaConfig)
AutoModelForCausalLM.register(LlamaConfig, Llama3_Seg3DForCausalLM)