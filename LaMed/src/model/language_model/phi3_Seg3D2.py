...
class LamedPhi3Config(Phi3Config):
    model_type = "phi3_seg3d"

class Phi3_Seg3DModel(LamedMetaModel, Phi3Model):
    config_class = LamedPhi3Config
    def __init__(self, config: Phi3Config):
        super(Phi3_Seg3DModel, self).__init__(config)


class Phi3_Seg3DForCausalLM(LamedMetaForCausalLM, Phi3ForCausalLM):
    config_class = LamedPhi3Config

    def __init__(self, config):
        super(Phi3_Seg3DForCausalLM, self).__init__(config)
        self.model = Phi3_Seg3DModel(config)
...
AutoConfig.register("phi3_seg3d", LamedPhi3Config)
AutoModelForCausalLM.register(LamedPhi3Config, Phi3_Seg3DForCausalLM)