term_dict = {
    ...
    "pancreas tumor": [
        "Abnormal cellular proliferation within pancreatic tissue.",
        "A neoplastic mass arising from the exocrine or endocrine cells of the pancreas.",
        "Uncontrolled growth of cells forming a lesion in the pancreas.",
        "A pathological cluster of cells disrupting pancreatic architecture.",
        "Malignant or benign tissue growth originating in the pancreas.",
        "Anomalous cell division leading to a tumor in the pancreatic parenchyma.",
        "A cellular mass caused by dysregulated apoptosis in pancreatic ducts or islets.",
        "Tumorous expansion compromising pancreatic function.",
        "A solid or cystic growth derived from pancreatic epithelial or stromal cells.",
        "Oncogenic transformation of pancreatic cells resulting in a tumor."
     ],
    "hepatic vessels tumor": [
        "An anomalous proliferation of vascular tissue within or around hepatic blood vessels.",
        "A space-occupying lesion originating from the vascular structures of the liver.",
        "A cluster of abnormally dividing cells localized within the hepatic vascular network (e.g., veins, arteries, or capillaries).",
        "A hyperplastic or neoplastic growth involving the endothelial or smooth muscle layers of hepatic vessel walls.",
        "Structural anomalies within hepatic vasculature, potentially altering blood flow dynamics.",
        "A focal mass of tissue developing within the lumen or surrounding the hepatic vessels.",
        "Atypical cellular proliferation of vascular endothelial cells or stromal components in the liver.",
        "Neoformation of tissue within the hepatic vascular system, distinct from normal vascular architecture.",
        "Abnormal cellular expansion associated with the anatomical framework of hepatic vessels.",
        "An intrahepatic lesion derived from vascular components, exhibiting distinct morphological features."
    ]
}