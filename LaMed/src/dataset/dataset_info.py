...
dataset_info = {
            ...
            '0002': ["spleen", "right kidney", "left kidney", "gallbladder", "esophagus", "liver", "stomach", "aorta",
            ...
            '0005': ['renal vein', 'kidney', 'renal artery', 'kidney tumor'],
            ...
            '0009': ['stones', 'artery', 'biliary system', 'bladder', 'bone', 'colon', 'gallbladder', 'heart',
                     ...
                     'liver cyst', 'liver tumor', 'liver tumor 01', 'liver tumor 02', 'liver tumor 03',
                     'liver tumor 04',
                     'liver tumor 05', 'liver tumor 06', 'liver tumor 07', 'liver tumor 1', 'liver tumor 2',
                     'liver tumors',
                     'lung', 'metal', 'metastasectomie', 'pancreas', 'portal vein', 'portal vein 1', 'right kidney',
                     'right lung', 'right suprarenal gland', 'right suprarenal tumor', 'skin', 'small bowel',
                     'spleen', 'stomach',
            ...
            '0010': ['liver', 'right kidney', 'spleen', 'pancreas', 'aorta', 'inferior vena cava',
                     ...
                     'left kidney'],
            '0011': ['left adrenal gland', 'right adrenal gland', 'aorta', 'autochthon left', 'autochthon right',
                     ...
                     'iliopsoas right', 'inferior vena cava', 'left kidney', 'right kidney', 'liver',
                     ...
                     'scapula left', 'scapula right', 'small bowel', 'spleen', 'stomach', 'trachea', 'bladder',
            ...
            '0012': ['liver', 'bladder', 'lung', 'kidney', 'bone', 'brain'],
            '0013': ['liver', 'spleen', 'left kidney', 'right kidney', 'stomach', 'gallbladder', 'esophagus',
                     'pancreas',
            ...
            '0018': ['colon cancer'],
            '0019': ['hepatic vessels', 'hepatic vessels tumor'],
            '0020': ['liver', 'liver tumor'],
            '0021': ['lung tumor'],
            '0022': ['pancreas', 'pancreas tumor'],
            '0023': ['spleen'],
